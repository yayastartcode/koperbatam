    ...
    <footer className="bg-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Koper Batam Tour Travel - Your trusted travel partner for amazing adventures and unforgettable experiences.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/people/Koperbatam-Tourtravel/61582005239663/"
                target="_blank"
              ...
              <a href="http://instagram.com/koperbatam_tourtravel/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.tiktok.com/@koperbatam.tourtr"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li className="flex items-start">
                ...
                <span>Ruko City Makmur Blok A/5, Kota Batam, Kepulauan Riau</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>koperbatamtt@gmail.com</span>
              </li>
            </ul>
          </div>
        ...
        <div
          ...
          <p>&copy; 2026 KOPERBATAM TOUR TRAVEL. All rights reserved.</p>
